...
public class CompoundsController {
    ...
    @Autowired
    ConnectServerAndChangeFileService cscfs;
    ...
    public String structureSearch(MultipartFile uploadFile, HttpServletRequest request) throws IOException {
...
//        String file_path = request.getParameter("uploadFile");
        if(!fileName.split(".")[1].equals("mol2") || !fileName.split(".").equals("sdf")){
            System.out.println("文件格式错误");
            return null;
        }
        String newFileName = fileName;
        String path = "src/java/main/resources/structure-files/orgin-files/";     /**
                                                            这里上传路径要改*/
